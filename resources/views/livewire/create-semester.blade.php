						...
						<div class="container mx-auto px-4">
							...
							<div class="space-y-8 divide-y divide-gray-200 w-80% mt-10">
										...
										<div class="flex">
											...
											<div class="ml-3">
												...
												<div class="mt-2 text-sm text-green-700">
													<p>New semester has been created.</p>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="sm:col-span-6">
									<label for="semester_name" class="block text-sm font-medium text-gray-700">
										Semester Name
									</label>
									<div class="mt-1">
										<input id="semester_name" wire:model="semesters.semester_name" name="semester_name" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5">
									</div>
								</div>
