                        ...
                        <div class="md:flex no-wrap md:-mx-2 ">
                            ...
                            <div class="w-3/12 md:mx-2">
                                ...
                                <div class="bg-white p-3 border-t-4 border-green-400">
                                    ...
                                    <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">{{ $profile->student_name }}</h1>
                                    ...
                                    <div class="text-gray-700">
                                        <div class=" text-sm">
                                            <div class="grid grid-cols-4">
                                                ...
                                                <div class="px-4 py-2">{{ $profile->student_name }}</div>
                                            </div>
                                            <div class="grid grid-cols-4">
                                                    ...
                                                    <div class="tab-content tab-space">
                                                        ...
                                                        <div class="hidden" id="tab-settings">
                                                            <div class="text-gray-700">
                                                                <div class="grid md:grid-cols-2 text-sm">
                                                                    ...
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Father's NRIC</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Mother's NRIC</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                    <div class="grid grid-cols-2">
                                                                    ...
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Father's Occupation</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Mother's Occupation</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Father's Income</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Mother's Income</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="hidden" id="tab-options">
                                                            <div class="text-gray-700">
                                                                <div class="grid md:grid-cols-2 text-sm">
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Guarantor 1 Name</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div>
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Guarantor 2 Name</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Guarantor 1 NRIC</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Guarantor 2 NRIC</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Guarantor 1 Phone Number</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div>                                                                       
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Guarantor 2 Phone Number</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div>
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Guarantor 1 Occupation</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Guarantor 2 Occupation</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Guarantor 1 Income</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                    <div class="grid grid-cols-2">
                                                                        <div class="px-4 py-2 font-semibold">Guarantor 2 Income</div>
                                                                        <div class="px-4 py-2">{{ $profile->student_name}}</div>
                                                                    </div> 
                                                                </div>
                                                            </div>
