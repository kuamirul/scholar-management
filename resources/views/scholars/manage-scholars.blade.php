<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
				  ...
				  <div class="p-6 bg-white border-b border-gray-200">
						...
						<div class="flex flex-row h-auto ">
						  <div class="w-full">
							...
							<button class="bg-pink-500 text-white active:bg-pink-600 font-bold justify-center uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-5 ease-linear transition-all duration-150" type="button" onclick="toggleModal('modal-id')">
								Create New Student
							</button>
							
							<button class="bg-pink-500 text-white active:bg-pink-600 font-bold justify-center uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-5 ease-linear transition-all duration-150" type="button" onclick="toggleModal('modal-csv')">
				...
				<div class="relative w-1/2 my-6 mx-auto max-w-full">
					...
					<div
						...
						<div
							...
							<button
								class="bg-emerald-500 text-black active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
			...
			<div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-csv">
				<div class="relative w-1/2 my-6 mx-auto max-w-full">
					<!--content-->
					<div
						class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
						...
						<div
							...
							<button
								class="bg-emerald-500 text-black active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
								type="button" onclick="toggleModal('modal-csv')">
								Close
							</button>
						</div>
					</div>
			...
			<div class="hidden opacity-25 fixed inset-0 z-40 bg-black" id="modal-csv-backdrop"></div>
